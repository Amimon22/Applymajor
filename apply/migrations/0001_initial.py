    ...
    operations = [
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        validators=[
                            ...
                            django.core.validators.MaxValueValidator(4.5),
                        ],
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        choices=[(1, "1순위"), (2, "2순위"), (3, "3순위"), (4, "4순위")]
                    ),
                ),
                (
                    "user",
                ...
                (
                    "major",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="apply.major"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "major_choices",
                    models.ManyToManyField(through="apply.Choice", to="apply.major"),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="apply.user_apply_profile",
            ),
        ),
        migrations.CreateModel(
            name="UserPriorChoice",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                ("change_count", models.PositiveIntegerField(default=3)),
